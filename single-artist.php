...
while ( have_posts() ) :
	...
	$img_id    = get_post_thumbnail_id( $artist_id );
	$img_url   = $img_id ? wp_get_attachment_image_url( $img_id, 'full' ) : '';
	$img_alt   = stolze_image_alt( $img_id, get_the_title() );
	...
	<div class="artist-page">
		<a href="<?php echo esc_url( $back_link ); ?>" class="back-link">&larr; Zurück zum Lineup</a>
		<div class="artist-page__body">
			<div class="artist-page__media">
				<?php if ( $img_url ) : ?>
